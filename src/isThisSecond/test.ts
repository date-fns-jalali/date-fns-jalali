...
describe("isThisSecond", () => {
  ...
  it("respects date extensions", () => {
    expect(
      isThisSecond(
        new UTCDate(
          /* 1393/7/3 */ +new Date(2014, 8 /* Sep */, 25, 18, 30, 15, 500),
        ),
      ),
    ).toBe(true);
  });
