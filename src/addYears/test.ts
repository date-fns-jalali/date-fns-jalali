...
describe('addYears', function() {
  it('adds the given number of years', function() {
    ...
    assert.deepStrictEqual(result, /* 1398/6/10 */ new Date(2019, 8 /* Sep */, 1))
  })

  it('accepts a timestamp', function() {
    const result = addYears(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1).getTime(), 12)
    assert.deepStrictEqual(result, /* 1405/6/10 */ new Date(2026, 8 /* Sep */, 1))
  })

  it('converts a fractional number to an integer', function() {
    const result = addYears(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 5.555)
    assert.deepStrictEqual(result, /* 1398/6/10 */ new Date(2019, 8 /* Sep */, 1))
  })
  ...
  it('handles the leap years properly', function() {
    ...
    assert.deepStrictEqual(result, /* 1395/12/10 */ new Date(2017, 1 /* Feb */, 28))
  })
