...
describe('setDay', function() {
  it('sets the day of the week', function() {
    var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 0)
  ...
  it('converts a fractional number to an integer', function() {
    var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 0.5)
    assert.deepEqual(result, /* 1393/6/9 */ new Date(2014, 7 /* Aug */, 31))
  })
  ...
  it('specifies Monday as the first day of the week', function() {
    var result = setDay(/* 1393/6/15 */ new Date(2014, 8 /* Sep */, 6), 1, {
      weekStartsOn: 1
    })
  ...
  context('the day index is more than 6', function() {
    it('sets the day of the next week', function() {
      var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 8)
      assert.deepEqual(result, /* 1393/6/16 */ new Date(2014, 8 /* Sep */, 7))
    })

    it('allows to specify which day is the first day of the week', function() {
      var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 7, {
        weekStartsOn: 1
      })
      assert.deepEqual(result, /* 1393/6/17 */ new Date(2014, 8 /* Sep */, 8))
    })
    ...
    it('sets the day of another week in the future', function() {
      var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 14, {
        weekStartsOn: 1
      })
  ...
  context('the day index is less than 0', function() {
    it('sets the day of the last week', function() {
      var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), -6)
  ...
  it('implicitly converts number arguments', function() {
    // $ExpectedMistake
    var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), '5')
  ...
  it('returns `Invalid Date` if the given amount is NaN', function() {
    var result = setDay(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), NaN)
    assert(result instanceof Date && isNaN(result))
  })
