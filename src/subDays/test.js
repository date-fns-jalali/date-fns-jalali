...
describe('subDays', function() {
  it('subtracts the given number of days', function() {
    var result = subDays(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 10)
  ...
  it('converts a fractional number to an integer', function() {
    var result = subDays(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 10.85)
    assert.deepEqual(result, /* 1393/5/31 */ new Date(2014, 7 /* Aug */, 22))
  })
  ...
  it('returns `Invalid Date` if the given amount is NaN', function() {
    var result = subDays(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), NaN)
    assert(result instanceof Date && isNaN(result))
  })
