...
describe('subYears', function() {
  it('subtracts the given number of years', function() {
    var result = subYears(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 5)
  ...
  it('converts a fractional number to an integer', function() {
    var result = subYears(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 5.1)
    assert.deepEqual(result, /* 1388/6/10 */ new Date(2009, 8 /* Sep */, 1))
  })
  ...
  it('handles the leap years properly', function() {
    var result = subYears(/* 1394/12/10 */ new Date(2016, 1 /* Feb */, 29), 1)
  ...
  it('returns `Invalid Date` if the given amount is NaN', function() {
    var result = subYears(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), NaN)
    assert(result instanceof Date && isNaN(result))
  })
