...
describe('endOfWeek', function() {
  ...
  it('allows to specify which day is the first day of the week', function() {
    ...
    assert.deepStrictEqual(result, /* 1393/6/16 */ new Date(2014, 8 /* Sep */, 7, 23, 59, 59, 999))
  })
  ...
  it('does not mutate the original date', function() {
    var date = /* 1393/6/11 */ new Date(2014, 8 /* Sep */, 2, 11, 55, 0)
    endOfWeek(date)
    assert.deepStrictEqual(date, /* 1393/6/11 */ new Date(2014, 8 /* Sep */, 2, 11, 55, 0))
  })
  ...
  describe('edge cases', function() {
    ...
    it('handles the week at the end of a year', function() {
      var date = /* 1393/10/8 */ new Date(2014, 11 /* Dec */, 29)
      var result = endOfWeek(date, { weekStartsOn: 5 })
      assert.deepStrictEqual(result, /* 1393/10/11 */ new Date(2015, 0 /* Jan */, 1, 23, 59, 59, 999))
    })
  })
