...
describe('subMilliseconds', function() {
  it('subtracts the given number of milliseconds', function() {
    ...
    assert.deepEqual(result, /* 1393/4/19 */ new Date(2014, 6 /* Jul */, 10, 12, 45, 29, 250))
  })
  ...
  it('accepts a timestamp', function() {
    ...
    assert.deepEqual(result, /* 1393/4/19 */ new Date(2014, 6 /* Jul */, 10, 12, 45, 29, 500))
  })
  ...
  it('does not mutate the original date', function() {
    ...
    assert.deepEqual(date, /* 1393/4/19 */ new Date(2014, 6 /* Jul */, 10, 12, 45, 30, 0))
  })
