...
describe("differenceInMinutes", () => {
  ...
  it("returns the number of minutes between the given dates with `trunc` as a default rounding method", () => {
    const result = differenceInMinutes(
      /* 1393/4/11 */ new Date(2014, 6 /* Jul */, 2, 12, 6, 50),
      /* 1393/4/11 */ new Date(2014, 6 /* Jul */, 2, 12, 20, 10),
    );
    assert(result === -13);
  });
  ...
  it("returns the number of minutes between the given dates with `trunc` passed in as a rounding method ", () => {
    const result = differenceInMinutes(
      /* 1393/4/11 */ new Date(2014, 6 /* Jul */, 2, 12, 20, 50),
      /* 1393/4/11 */ new Date(2014, 6 /* Jul */, 2, 12, 6, 10),
  ...
  it("returns the number of minutes between the given dates with `round` passed in as a rounding method ", () => {
    const result = differenceInMinutes(
      /* 1393/4/11 */ new Date(2014, 6 /* Jul */, 2, 12, 20, 60),
      /* 1393/4/11 */ new Date(2014, 6 /* Jul */, 2, 12, 6, 10),
  ...
  it("accepts timestamps", () => {
    const result = differenceInMinutes(
      /* 1393/6/14 */ new Date(2014, 8 /* Sep */, 5, 18, 45).getTime(),
      /* 1393/6/14 */ new Date(2014, 8 /* Sep */, 5, 18, 15).getTime(),
    );
    assert(result === 30);
  });
  ...
  describe("edge cases", () => {
    it("the difference is less than a minute, but the given dates are in different calendar minutes", () => {
      const result = differenceInMinutes(
        /* 1393/6/14 */ new Date(2014, 8 /* Sep */, 5, 12, 12),
        /* 1393/6/14 */ new Date(2014, 8 /* Sep */, 5, 12, 11, 59),
      );
      assert(result === 0);
    });
    ...
    it("the difference is an integral number of minutes", () => {
      const result = differenceInMinutes(
        /* 1393/6/14 */ new Date(2014, 8 /* Sep */, 5, 12, 25),
        /* 1393/6/14 */ new Date(2014, 8 /* Sep */, 5, 12, 15),
      );
      assert(result === 10);
    });
