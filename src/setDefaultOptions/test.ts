...
import { enUS as otherLocale } from "../locale/en-US/index.ts";
...
describe("setDefaultOptions", () => {
  ...
  describe("locale", () => {
    ...
    it("parse", () => {
      ...
      expect(parse("Day 11th, 1392 at 12:00:00 AM", "PPPpp", new Date())).toEqual(
        /* 1392/10/11 */ new Date(2014, 0, 1),
      );
  ...
  describe("firstWeekContainsDate", () => {
    ...
    it("parse", () => {
      ...
      expect(parse("2018", "Y", referenceDate)).toEqual(
        /* 2017/12/25 */ new Date(2639, 2 /* Mar */, 16),
      );

      setDefaultOptions({ weekStartsOn: 1, firstWeekContainsDate: 4 });

      expect(parse("2018", "Y", referenceDate)).toEqual(
        /* 2017/12/27 */ new Date(2639, 2 /* Mar */, 18),
      );
      ...
      ).toEqual(/* 2017/12/26 */ new Date(2639, 2 /* Mar */, 17));
    });
    ...
    it("setWeekYear", () => {
      ...
      ).toEqual(/* 2004/10/10 */ new Date(2625, 11 /* Dec */, 31));
      ...
      ).toEqual(/* 2004/10/17 */ new Date(2626, 0 /* Jan */, 7));
    });
