...
describe("parse", () => {
  ...
  describe("time zones", () => {
    it("properly parses dates around DST transitions", () => {
      ...
      expect(
        parse("1401-12-20 01:30", format, new Date(), { in: ny }).toISOString(),
      ).toBe("2023-03-11T01:30:00.000-05:00");
      expect(
        parse("1401-12-21 01:30", format, new Date(), { in: ny }).toISOString(),
      ).toBe("2023-03-12T01:30:00.000-05:00");
      expect(
        parse("1401-12-21 02:00", format, new Date(), { in: ny }).toISOString(),
      ).toBe("2023-03-12T03:00:00.000-04:00");
      expect(
        parse("1401-12-21 03:00", format, new Date(), { in: ny }).toISOString(),
      ).toBe("2023-03-12T03:00:00.000-04:00");
      expect(
        parse("1401-12-21 03:30", format, new Date(), { in: ny }).toISOString(),
      ).toBe("2023-03-12T03:30:00.000-04:00");
      expect(
        parse("1401-12-22 03:30", format, new Date(), { in: ny }).toISOString(),
