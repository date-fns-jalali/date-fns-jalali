...
describe('subWeeks', function() {
  it('subtracts the given number of weeks', function() {
    var result = subWeeks(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 4)
  ...
  it('converts a fractional number to an integer', function() {
    var result = subWeeks(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), 4.2)
    assert.deepEqual(result, /* 1393/5/13 */ new Date(2014, 7 /* Aug */, 4))
  })
  ...
  it('returns `Invalid Date` if the given amount is NaN', function() {
    var result = subWeeks(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1), NaN)
    assert(result instanceof Date && isNaN(result))
  })
