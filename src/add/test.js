...
describe('add', function() {
  ...
  it('returns same date object when passed empty duration values', function() {
    ...
    assert.deepEqual(result, /* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1, 10))
  })
  ...
  it('accepts a timestamp', function() {
    ...
    assert.deepEqual(result, /* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1, 14))
  })

  it('converts a fractional number to an integer', function() {
    var result = add(/* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1, 10), {
      hours: 4.2
    })
    assert.deepEqual(result, /* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1, 14))
  })
  ...
  it('does not mutate the original date', function() {
    var date = /* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1, 10)
    add(date, { hours: 4 })
    assert.deepEqual(date, /* 1393/6/10 */ new Date(2014, 8 /* Sep */, 1, 10))
  })

  it('works well if the desired month has fewer days and the provided date is in the last day of a month', function() {
    var date = /* 1393/10/10 */ new Date(2014, 11 /* Dec */, 31)
    var result = add(date, { months: 9 })
    assert.deepEqual(result, /* 1394/7/10 */ new Date(2015, 9 /* Sep */, 2))
  })
